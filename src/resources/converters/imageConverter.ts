...
/**
 * Get LVGL color format constant
 */
function getLvglColorFormat(format: ImageFormat, hasAlpha: boolean): string {
  switch (format) {
    case 'RGB565':
...
export function generateImageCCode(
  ...
  const cfFormat = getLvglColorFormat(options.format, hasAlpha);
