/**
 * LVGL 9.5 configuration for the EDT EVK043027B runtime.
 */
#ifndef LV_CONF_H
#define LV_CONF_H

/* 32-bit colour. The LTDC on this board could scan a packed 24 bpp layer, and
   the vendor's TouchGFX demo does, but this is an LVGL product and runs
   ARGB8888 — see docs/color-depth.md and board_display.c. */
